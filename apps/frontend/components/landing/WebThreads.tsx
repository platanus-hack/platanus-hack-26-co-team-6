...
/**
 * WebThreads (React Bits) — hilos de luz WebGL con OGL, portado a TS.
 * Única adaptación respecto al original: el mouse se sigue a nivel de
 * window (el contenido del hero cubre el canvas, así que los listeners
 * sobre el propio canvas nunca dispararían).
 */
...
const WebThreads = ({
  ...
  useEffect(() => {
    ...
    // Seguimiento a nivel de window: activo solo mientras el cursor está
    // sobre el área del canvas (el contenido de arriba no lo bloquea).
