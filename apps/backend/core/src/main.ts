...
import { MAX_AUDIO_MB } from './voz/voz.service';
...
async function bootstrap() {
  ...
  //
  // Va ANTES de enableCors y del resto: express aplica los middlewares en
  // orden de registro y este tiene que ganarle al body parser de Nest.
  app.use(
    '/voz/transcribir',
